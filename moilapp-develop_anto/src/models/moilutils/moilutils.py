...
from moil_fisheye_marker import fisheye_marker
from components.select_media_source import CameraSource
from moil_3d_algorithm import Moil3dAlgorithm
...
from components.resource_icon_and_pixmap import GetResourcesIcon
...
class MoilUtils:
    def __init__(self):
        ...
        self.marker = fisheye_marker.MoilFisheyeMarker()
        self.moil3d = Moil3dAlgorithm()
