...
#
# print(MoilCam.scan_id('raspberry_pi4_ip_cam'))
#
# print(MoilCam.valid_resolution('raspberry_pi4_ip_cam'))
#
# cam = MoilCam('raspberry_pi4_ip_cam', 'http://10.42.0.31:8000/stream.mjpg', (2592, 1944))
#
