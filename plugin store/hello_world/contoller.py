...
class Controller(QWidget):
    ...
    def connect_to_button(self):
        ...
        self.ui.push_save.clicked.connect(self.save_config)
    ...
    def save_config(self):
        ...
        print("test here", data)

    def setup_save(self):
        data = {"data recenter_img": {
            "alpha_max": self.ui.doubleSpinBox.value(),
            "alpha": self.ui.doubleSpinBox_2.value(),
            "beta": self.ui.doubleSpinBox_3.value()
        }}
        return data
