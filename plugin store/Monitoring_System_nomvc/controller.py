...
class Controller(QWidget):
    ...
    def set_stylesheet(self):
        ...
        self.setStyleSheet(self.model.pushbutton_stylesheet())
    ...
    def show_image_point_z1(self):
        ...
        if self.click_z1 is not None:
            self.model.show_image_to_label(self.ui.label_63, self.click_z1, 200)
    def show_image_point_z2(self):
        self.model.show_image_to_label(self.ui.label_17, self.remap_z2, 600)
        if self.click_z2 is not None:
            self.model.show_image_to_label(self.ui.label_65, self.click_z2, 200)
